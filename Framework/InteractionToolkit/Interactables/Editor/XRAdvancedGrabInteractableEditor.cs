...
namespace Framework
{
    namespace Interaction.Toolkit
    {
        ...
        {
            /// <summary>
            /// Custom editor for an <see cref="XRAdvancedGrabInteractable"/>.
            /// </summary>
            ...
            public class XRAdvancedGrabInteractableEditor : XRBaseInteractableEditor
            {
                ...
                /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XRGrabInteractable.constrainInteractorPosition"/>.</summary>
                protected SerializedProperty m_ConstrainInteractorPosition;
                /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XRGrabInteractable.constrainInteractorRotation"/>.</summary>
                protected SerializedProperty m_ConstrainInteractorRotation;
                ...
                protected static class Contents
                {
                    ...
                    /// <summary><see cref="GUIContent"/> for <see cref="XRGrabInteractable.constrainInteractorPosition"/>.</summary>
                    public static readonly GUIContent constrainInteractorPosition = EditorGUIUtility.TrTextContent("Constrain Interactor Position", "Force an interactors position be set to this Interactable's position whilst interacting with it.");
                    /// <summary><see cref="GUIContent"/> for <see cref="XRGrabInteractable.constrainInteractorRotation"/>.</summary>
                    public static readonly GUIContent constrainInteractorRotation = EditorGUIUtility.TrTextContent("Constrain Interactor Rotation", "Force an interactors rotation be set to this Interactable's rotation whilst interacting with it.");
                }
                ...
                protected override void OnEnable()
                {
                    ...
                    m_ConstrainInteractorPosition = serializedObject.FindProperty("m_ConstrainInteractorPosition");
                    m_ConstrainInteractorRotation = serializedObject.FindProperty("m_ConstrainInteractorRotation");
                }
                ...
                /// <summary>
                /// Draw the property fields related to grab constraints.
                /// </summary>
                protected virtual void DrawGrabConstraints()
                {
                    EditorGUILayout.PropertyField(m_ConstrainInteractorPosition, Contents.constrainInteractorPosition);
                    EditorGUILayout.PropertyField(m_ConstrainInteractorRotation, Contents.constrainInteractorRotation);
                }
                /// <summary>
